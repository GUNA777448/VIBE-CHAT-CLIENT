    ...
    <div className="
      ...
      <div className="
        ...
        <div className="flex flex-col items-center mt-[45px]">
          ...
          <h2 className="mt-3 text-lg font-semibold mb-[0px]">Mahmud Nik</h2>
          <p className="mt-[0px] text-sm text-white/80">Ph no: 8952468797</p>
        </div>
      </div>
      ...
      <div className="
        ...
        <MenuItem icon={<FiLogOut />} label="Sign Out" />
      </div>
  ...
  return (
    <div className="bg-[black]/7 flex items-center justify-between bg-[#f6f8ff] mx-[20px] mt-[20px] px-[10px] pt-3 rounded-[15px] cursor-pointer hover:bg-[#eef1ff] transition">
      <div className="h-[60px]  flex items-center gap-3 text-[#5b7cfa]">
        ...
        <span className="ml-[20px] text-sm text-gray-700 text-[black]/70 text-[20px]">{label}</span>
      </div>
    </div>
  );
}
